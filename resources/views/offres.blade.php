...
<span class="price-value mt-2"> A partir de: </br><span class="month"><strong>5 900 FCFA/</strong><small>mois</small></span><span class="mit1"> pour un kit au choix</span> </span>-->
                 ...
                 <ul style="padding-bottom: 8px ; padding-top: 19px;"> 
                           ...
                           <p style="font-size:15px;"  class="font-weight-bold "><strong>KIT VIDEOSURVEILLANCE </strong><br/><span class=" " style= "color: #FF3333; "> avec 4 caméras et 1 moniteur avec NRV intégré </span> </p> 
...
avec 1 kit Zen Premium </p>
                          ...
                          <p style="color: #FF3333;"  class="font-weight-bold ">+ 1 clavier d’alarme <br/>+ Jusqu’à 7 accessoires </p>
                           ...
                           <!--  <li>Détection risque domestique</li>
                            ...
                            <p style="color: #FF3333; font-size: 15px;"><strong>TELESURVEILANCE + AGENT MOBILE </strong></p>

                            <li  class="font-weight-bold " style="color: #FF3333;"> Levée de doute à distance</li>
                            <li style="color: #FF3333;"  class="font-weight-bold ">Levée de doute physique</li>
    ...
    <ul>
                           <p style="color: #FF3333;font-size:15px;"><strong>ESPACE ABONNE</strong> </p>
        ...
        <div class="row" style="width: 100%;margin-left: 62px; margin-top: 80px;margin-top: 80px; margin-left:10px;">
<!--
<table class="table">
 <thead>
     <tr>
      <th class="titre3" width="100% " style="color:#fff; display: block;border-top-right-radius: 20px; background: black;  border-bottom-left-radius: 20px; "><strong>tableau comparatif</strong></th>
   ...
   <tbody>
    <tr>
      ...
      <td>@twitter</td>
            ...
            <div class="row">
                <!--La classe bg-danger ajoute un fond rouge à l'élément-->
            </div>


<div class="container"  style="padding-bottom:100px; padding-top: 30px;padding-left:30px">
...
">Tableau comparatif</strong>
</p></div>
<!--<div class="col-md-2" width="20%"><p align="center"> &nbsp;&nbsp;<strong>2</strong></p></div>-->
<div class="col-lg-2 col-lg-2 "><p  style="margin-left: 80px;"> &nbsp;&nbsp;<strong>23 600 </strong></p></div>

<div class="col-lg-2 col-md-2 "><p  style="margin-left: 80px;"> &nbsp;&nbsp;<strong>23 65</strong></p></div>
...
<table class="table">
  <thead class="thead-dark">
    <tr>
                     <div class="col bg-black" style="background: black;
    font-size: 1.2em;
    color: #fff;
 text-transform: none;
     font-weight: 600;
    ...
    border-bottom-left-radius: 20px; ">Tableau comparatif</div>
  ...
  <tbody>
    <tr>
      <th scope="row">Tableau comparatifTableau comparatif</th>
      <td> <i class="fa fa-check" style="color:orange;"></i></td>
      <td><i class="fa fa-check" ></i></td>
      <td><p><i class="fa fa-check" style="color:orange;"></i></p></td>
    </tr>
    <tr>
      <th scope="row">Tableau comparatifTableau comparatif</th>
      <td>Senvigile</td>
 ...
 text-transform: none;
  ...
  <tbody>
    <tr>
      ...
      <td>  Senvigile</td>
      <td>Senvigile</td>
      <td><p><i class="fa fa-check" style="color:red;"></i></p></td>
    </tr>
    <tr>
      <th scope="row">Tableau comparatifTableau comparatif</th>
      <td>Senvigile</td>
...
<table class="table">
  ...
  <tbody>
    <tr>
      <th scope="row"><p>Tableau comparatifTableau comparatif</p></th>
      <td><p> <span class="" >Senvigile</span>
      </p>
</td>
      <td><i class="fa fa-check" ></i></td>
      <td><p><i class="fa fa-check" style="color:red;"></i></p></td>
 ...
 text-transform: none;
  ...
  <tbody>
    <tr>
      ...
      <td><p><i class="fa fa-check" ></i></p></td>
      <td>Senvigile</td>
      <td><p><i class="fa fa-check" style="color:orange;"></p></td>
    </tr>
    <tr>
      <th scope="row">Tableau comparatifTableau comparatif</th>
      <td>Senvigile</td>
