...
<div class="container">
    ...
    <div  class="col-md-12 col-lg-12 mt-2 mb-5">
        <div class="post-media wow fadeIn mt-4">
                             <img src="{{asset('images/zenprem.png')}}" alt="" class="img-fluid"  style="color:white;max-width: 100%;">
                    </div><!-- end media -->
...
<table class="table table-bordered table-hover" style="text-align: center;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="2"class="table-active " >Emails illimité , 50 SMS/mois et 30 appels </td>
    </tr>
...
<tr>
    ...
    <tr> 
      ...
      <td colspan="2" class="table-active ">1fois </td>
    </tr> 
    <tr>
    ...
    border-bottom-right-radius: 10px; 
      ...
      <th scope="row">Compte Utilisateurs</th>
            <td colspan="2" class="table-active ">2 </td>
    </tr>

    <tr>
      
           <th scope="row">Capacité stockage</th>
            <td colspan="2" >Jusqu’à 1.5Gb </td>
    </tr>
    ...
    <tr>
           <th scope="row">Historique</th>
            <td colspan="2" class="table-active ">2 semaines</td>
    </tr>
