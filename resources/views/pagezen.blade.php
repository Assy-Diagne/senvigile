...
<table class="table table-bordered table-hover" style="text-align: center;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> </td>
      <td style="color:#FBB226;" class="font-weight-bold ">X</td>
    </tr>
    <tr>
      <th scope="row" style="background: #FBB226;
    font-size: 1.2em;
    ...
    <tr>
      ...
      <td colspan="2" class="table-active ">Emails illimité, 20 SMS et 20 appels  </td>
    </tr>
    ...
    <tr>
      ...
      <th scope="row"> <sup>2</sup>Information immédiate de l'abonné</th>
      <td class="font-weight-bold ">Y   </td>
      <td class="font-weight-bold ">Y </td>
    </tr>
     <tr>
...
<tr>
    ...
    <tr> 
      ...
      <td style="color:#FF9933;" class="font-weight-bold ">X </td>
      <td style="color:#FBB226;" class="font-weight-bold ">X</td>
    </tr> <tr>
    ...
    border-bottom-right-radius: 10px; 
      ...
      <th scope="row">Compte Utilisateurs</th>
            <td colspan="2" class="table-active ">1 compte unique </td>
    </tr>

    <tr>
      
           <th scope="row">Capacité stockage</th>
            <td colspan="2" >Jusqu’à 80 évènements </td>
    </tr>
    ...
    <tr>
           <th scope="row">Historique</th>
            <td colspan="2" class="table-active ">1 semaine </td>
    </tr>
  ...
  <div class="pricingTable-sign-up  mt-md-3  " >
                        ...
                        <a href="{{route('imvid')}}" class="hover-btn-new" id="readmore" ><span>Commandez Maintenant</span></a>
                    </div><!-- BUTTON BOX-->
