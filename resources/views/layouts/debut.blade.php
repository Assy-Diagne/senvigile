          ...
          <button class="btn btn-outline-success" type="submit"><i class="fas fa-search" style="color:light;"></i></button>
                ...
                @auth
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item {{ Request::is('welcome') ? 'active' : '' }}"><a class="nav-link" href="{{ route('welcome') }}">Accueil</a></li>
                        <li class="nav-item {{ Request::is('features') ? 'active' : '' }}"><a class="nav-link" href="{{ route('Solutions')}}">Solutions </a></li>
                                                 <li class="nav-item {{ Request::is('services') ? 'active' : '' }}"><a class="nav-link" href="{{ route('Services') }}">Produits et Services</a></li>
                    ...
                    <!--  <li class="nav-item {{ Request::is('domain') ? 'active' : '' }}"><a class="nav-link" href="{{ route('Support') }}">Support</a></li>-->
                        ...
                        <li class="nav-item {{ Request::is('offres') ? 'active' : '' }}"><a class="nav-link" href="{{ route('offres') }}">Offres</a></li>
                    <!--  <li class="nav-item {{ Request::is('domain') ? 'active' : '' }}"><a class="nav-link" href="{{ route('Support') }}">Support</a></li>-->
...
<li class="nav-item mr-2">
                        ...
                        @guest
                            <ul class="navbar-nav ml-auto" >
                                ...
                                <!-- phase test<li class="nav-item active"><a class="nav-link" href="index.html">Home</a></li>-->
                                <li class="nav-item {{ Request::is('/') ? 'active' : '' }}"><a class="nav-link" href="{{ route('welcome') }}">Accueil</a></li>
                                                        <li class="nav-item {{ Request::is('features2') ? 'active' : '' }}"><a class="nav-link" href="{{ route('Solutions')}}">Solutions </a></li>
                                                 <li class="nav-item {{ Request::is('services') ? 'active' : '' }}"><a class="nav-link" href="{{ route('Services') }}">Produits et Services</a></li>
                                 <!--<li class="nav-item {{ Request::is('hosting') ? 'active' : ''}}"><a class="nav-link" href="{{ route('Application') }}">Applications </a></li>-->
